...
contract Auction {
    ...
    event start(uint256 startDate, uint256 endAt);

    receive() external payable {}

    function initAuction(uint256 duration, IERC721 nft, uint256 tokenId, uint256 prePrice) external {
    ...
    function addBid(uint256 price, address sellerAddr) external {
