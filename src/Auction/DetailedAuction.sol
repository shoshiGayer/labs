...
//     constructor(){
//         // bidders[address(this)].sum = bidder.seller.startSum;
...
//     function addBid(uint _sum, Seller memory seller) public payable checkTime(seller){
...
//     }
//     function removeBid(Seller memory seller) public checkTime(seller){
//         removeBidByOwner(seller,msg.sender);
//     }
//     function removeBidByOwner(Seller memory seller,address addr) public payable checkTime(seller){
//         addr.transfer(bidders[addr].sum);
//         bidders[addr].sum = 0;
//         bidders[addr].flag = false;
//     }
//     //החזרת כספים אחרי סיום
//     function returnMoney(Seller memory seller) public{
...
//     function finishAuction(Seller memory seller) public {
//         while(!bidders[stack[stack.length()-1]].flag){
//             stack.pop();
//         }
